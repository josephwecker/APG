% fastpeg.tex, dated 25th April 2011
% Paper outlining a fast compiler for a statically processed PEG grammar.
%
% (c) 2011 Joseph A. Wecker
%
...
% Page heads
\markboth{J. A. Wecker}{Fast Linear Parsing for PEGs in Constant Space}

% Title portion
\title{Fast Linear Parsing for PEGs in Constant Space}
\author{Joseph A. Wecker}

\begin{abstract}
I hope this goes well enough.
\end{abstract}
...
\acmformat{Wecker, J. 2010. Fast Linear Parsing for PEGs in Constant Space}

\begin{bottomstuff}
Author's addresses: Joseph Wecker, Sunnyvale CA
\end{bottomstuff}
